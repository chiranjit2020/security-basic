...
!!! question "The question"
    When people say "make the application secure," secure *against what*, exactly?
    What are the properties you are actually trying to protect?

Let's build **CIA Triad as an engineering mental model**, not as an exam definition.
